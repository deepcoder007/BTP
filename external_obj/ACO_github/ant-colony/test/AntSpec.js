...
describe('Ant', function () {
  ...
  describe('#walkUpRight(worldState)', function () {
    ...
    it('does not go out of bounds when position is [0][0]', function () {
      worldStateIsValidStub.returns(false);
      ant.setDirection('S');
      ant.setPosition(0, 0);
      ant.walkUpRight(worldState);
    ...
    it('has 50% chance of facing "W" when starting direction is "S"', function () {
      randomStub.returns(.51);
      ant.setDirection('S');
      ant.walkUpRight(worldState);
    ...
    it('walks to [x - 1][y + 1] when direction is "W"', function () {
      ant.setDirection('W');
      ant.walkUpRight(worldState);
  ...
  describe('#getLeftPosition()', function () {
    ...
    it('returns [x][y + 1] when direction is "E"', function () {
      ant.setDirection('E');
    ...
    it('returns [x][y - 1] when direction is "W"', function () {
      ant.setDirection('W');

      assert.deepEqual(ant.getLeftPosition(), [5, 4]);
    });
  });
});
